...
export class GameEffects {
  ...
  showCriticalFailure() {
    ...
    const wrapper = document.createElement('div');
    wrapper.id = 'critical-failure-overlay';
    ...
    const title = document.createElement('div');
    title.id = 'critical-failure-title';
    ...
    `;
    // jsdom can be spotty with parsing animation/font-family from cssText; set explicitly for tests.
    title.style.fontFamily = "'Orbitron', monospace";
    title.style.color = '#ff0000';
    title.style.animation = 'rgb-split 0.2s ease-in-out infinite';
