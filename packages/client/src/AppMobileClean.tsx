...
export default function AppMobileClean() {
  return (
    <WalletProvider>
      <WsProvider>
        <AppInner />
...
function Practice({ onFinish: _onFinish, onBack }: { onFinish: () => void; onBack: () => void; }) {
  ...
  const [boostCooldown, setBoostCooldown] = useState(1);
    ...
    return (
      <div className="screen active" style={{ padding: 0, position: 'fixed', inset: 0, width: '100vw', height: '100vh', zIndex: 100 }}>
        ...
        <MobileTouchControls 
          ...
          onBoost={handleBoost}
          canBoost={canBoost}
          boostCooldownPct={boostCooldown}
        />
        {/* Show tutorial during first 5 seconds */}
        <MobileTutorial countdown={5} />
      </div>
    );
  }
    ...
    <div className="screen active mobile-lobby-screen">
      <div className="mobile-lobby-container">
        ...
        <div className="mobile-lobby-orbit">
          ...
          {state.countdown && (
            <div className="mobile-countdown">{state.countdown.remaining}s</div>
          )}
        </div>
  ...
  return (
    <div className="screen active" style={{ padding: 0, position: 'fixed', inset: 0, width: '100vw', height: '100vh', zIndex: 100 }}>
      ...
      <MobileTouchControls 
        ...
        boostCooldownPct={boostCooldown}
      />
      {/* Show tutorial during first 5 seconds of tournament game */}
      <MobileTutorial countdown={5} />
    </div>
  );
}
