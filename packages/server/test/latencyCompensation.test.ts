...
describe('LatencyCompensation', () => {
  ...
  describe('RTT Measurement', () => {
    it('should accurately measure RTT from ping/pong', () => {
      ...
      // Simulate a 50ms RTT by setting the pong receive time after the ping send time
      const receivedAt = ping!.timestamp + 50;
      latencyComp.processPong(playerId, ping!.pingId, receivedAt);
